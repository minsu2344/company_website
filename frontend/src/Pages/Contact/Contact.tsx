...
function Contact() {
  const formLabelStyle = 'block text-gray-700 font-medium mb-2';
  const formInputStyle =
    'w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-colors';
          ...
          <div>
            <form className='bg-white rounded-2xl shadow-xl p-8'>
              <div className='space-y-6'>
                <div>
                  <label className={formLabelStyle}>이름</label>
                  <input
                    type='text'
                ...
                <div>
                  <label className={formLabelStyle}>이메일</label>
                  <input
                    type='email'
                    className={formInputStyle}
                ...
                <div>
                  <label className={formLabelStyle}>연락처</label>
                  <input
                    type='tel'
                    className={formInputStyle}
                ...
                <div>
                  <label className={formLabelStyle}>문의 내용</label>
                  <textarea
              ...
              <div className='space-y-6'>
                {[
                  ...
                  <div key={index} className='flex items-start'>
                    <div className='bg-blue-100 p-3 rounded-lg text-xl text-blue-600'>
                      {item.icon}
                    </div>
                    <div className='ml-4'>
